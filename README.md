...
> Answer:
Using Client-side routing the page does not "refresh" in the sense that it does not call the server for information on the page.  Instead what happens is the react router routes from page to page on the client's side: maximizing speed and efficiency when going from page to page. 
## Project Set Up
...
- [Xlet]  **RUN** `yarn start` or `npm start` to fire up your React application.
